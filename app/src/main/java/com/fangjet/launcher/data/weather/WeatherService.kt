...
import com.fangjet.launcher.data.preferences.WeatherPreferencesDataSource
import com.fangjet.launcher.data.weather.WeatherService.Companion.LOCATION_TIMEOUT_MS
...
import com.fangjet.launcher.util.resolveWeatherUnits
...
class WeatherService @Inject constructor(
    ...
    private fun buildCurrentUrl(
        lat: Double,
        lon: Double,
        units: com.fangjet.launcher.domain.model.WeatherUnits,
